        ...
        >
            {cards.map((card, idx) => (
                <motion.div
                    ...
                    className={`flex items-center justify-between p-6 bg-base-100 rounded-2xl border border-base-300 shadow-sm hover:shadow-md transition-shadow duration-200`}
                >
